                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p><b> {{ $student->user->email }} </b></p>
                                    <hr>
                                </div>
                                <div class="col-md-3">
                                    <small class="">CNIC: </small>
                                    <p><b> {{ $student->cnic }} </b></p>
                                    <hr>
                                </div>
                                <div class="col-md-3">
                                    <small class="">WHATSAPP: </small>
                                    <p><b> {{ $student->whatsapp }} </b></p>
                                    <hr>
                                </div>
                                <div class="col-md-3">
                                    <small class="">QUALIFICATION: </small>
                                    <p><b> {{ $student->qualification->name }} @if($student->qualification->parent) ( {{ $student->qualification->parent->name }} ) @endif </b></p>
                                    <hr>
                                </div>
                                <div class="col-md-6">
                                    <small class="">Address: </small>
                                    <p><b> {{ $student->address ?? 'N/A' }} </b></p>
                                    <hr>
                                </div>
                            </div>
                        </div>
