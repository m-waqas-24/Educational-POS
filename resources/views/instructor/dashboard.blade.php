                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif --}}
                                        <a href="{{ route('instructor.allBatches', ['instructorId' => $cours->instructor_id, 'courseId' => $cours->course_id]) }}" class="btn btn-warning" ><i class="fa fa-eye mr-2"></i>Batches</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
